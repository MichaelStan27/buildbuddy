...
public interface CommentRepository extends JpaRepository<CommentEntity, Integer>, JpaSpecificationExecutor<CommentEntity> {
    ...
    @Query(nativeQuery = true, value = "select c.comment_id as commentId, u.username as username, u.profile_picture as userProfile, c.message as message, c.thread_id as threadId, c.created_time as createdTime, c.last_update_time as lastUpdateTime " +
