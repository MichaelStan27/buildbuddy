...
public interface ThreadRepository extends JpaRepository<ThreadEntity, Integer>, JpaSpecificationExecutor<ThreadEntity> {
    ...
    @Query(nativeQuery = true, value = "select t.thread_id as threadId, t.post as post, u.username as username, u.profile_picture as userProfile, t.created_time as createdTime, t.last_update_time as lastUpdateTime " +
            ...
            ") ")
    Page<ThreadModel> getByCustomParam(@Param("threadId") Integer threadId, @Param("search") String search, Pageable pageable);
}
